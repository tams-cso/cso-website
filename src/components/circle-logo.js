...
const CircleLogo = () => (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" vector-effect="non-scaling-stroke" class="circle-logo" style={{display: 'block', maxWidth: '100%', margin: 0, fill: 'none', stroke: 'cyan'}}>
